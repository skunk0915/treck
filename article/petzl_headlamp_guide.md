# 初めてのナイトハイクに！ペツルのヘッドライト、どれを選べば正解？
Tags: Headlamp, Guide

## 導入

「ペツルのヘッドライトがいいって聞くけど、種類が多すぎてどれを選べばいいかわからない…」そんな悩みを抱えていませんか？ティカ、アクティック、スイフト…名前を見ても違いがよくわからない。でもナイトハイクデビューするなら、信頼できるライトが欲しい。

この記事では、登山ガイド歴20年の先生と登山初心者のJKが、ペツルのヘッドライトを徹底解剖。どのモデルが自分に合っているのか、一緒に見つけていきましょう。

---

## 登場人物紹介

**JK（女子高生）**: 登山初心者。形から入りたい派。「長持ち」「軽い」「かわいい」が大事なポイント。

**先生（登山ガイド）**: 登山歴20年のベテラン。機能美を愛し、道への愛と知識が深い。

---

## ペツルって何が違うの？

**JK**: 先生、ヘッドライトって色々あるじゃないですか。100均にもあるし。なんでわざわざペツル？
...
**先生**: まず、**「ハイブリッドコンセプト」**という仕組みがある。専用の充電池「COREバッテリー」と、どこでも買える単4乾電池の両方が使えるんだ。

**JK**: え、それってすごくないですか？充電切れても乾電池でなんとかなるってこと？
...
**先生**: ペツルのヘッドライトは、大きく3つのシリーズに分かれている。

**JK**: シリーズ…？

**先生**: 用途によって設計が違うんだ。整理しよう。

### シリーズ一覧

| シリーズ名 | 特徴 | 対象ユーザー |
|-----------|------|-------------|
| **DISCOVER** | シンプル・軽量・お手頃 | 初心者・キャンプ・日帰り登山 |
...
**先生**: 基本はそうだ。だが、ナイトハイクをするなら「ADVANCED」まで視野に入れたほうがいい。
...
## 予備・キャンプ派なら「TIKKINA（ティキナ）」

**先生**: まずは一番シンプルな「ティキナ」から紹介しよう。

#### 主なスペック
- 最大ルーメン: 300lm
- 重量: 約92g（電池込み）
- 電源: 単4電池×3 / COREバッテリー対応
- 防水性能: IPX4
- 価格: 約4,000〜5,000円
...
**先生**: その理解でいい。山小屋泊の予備として持っておくと安心だ。
...
#### 注意点
- 赤色ライトが非搭載
- 本格的なナイトハイクには明るさが物足りない可能性

---

## 万能派なら「TIKKA（ティカ）」

**先生**: 次は「ティカ」だ。ペツルの代表作と言っていい。

**JK**: ティキナとティカ…名前似すぎじゃないですか？

**先生**: よく言われる。だが性能は明確に違う。

#### 主なスペック
- 最大ルーメン: 350lm（COREバッテリー使用時450lm）
- 重量: 約94g（電池込み）
- 照射距離: 65〜70m
- 電源: 単4電池×3 / COREバッテリー対応
- 防水性能: IPX4
...
**先生**: 暗闘でもぼんやり光ってくれる素材だ。テントの中で「ライトどこ行った！？」がなくなる。

**JK**: それは地味に便利ですね！

**先生**: 赤色ライトも搭載されている。

**JK**: 赤色ライトって何に使うんですか？赤いと見づらくないですか？

**先生**: 夜間視力を維持するためだ。白い光を見ると瞳孔が絞まって、消した後しばらく暗闇が見えづらくなる。赤色光ならそれが起きにくい。

**JK**: 星空撮影のときとかに使えそう…！

**先生**: その通りだ。山小屋で周囲の人を眩しくさせないためにも使える。
...
#### 注意点
- 本格的なナイトトレイルには明るさが心細い
- ビームパターンの切り替え機能はなし

---

## 本格派なら「ACTIK CORE（アクティック コア）」

**先生**: ナイトハイクや縦走をするなら、ここからが本命だ。
...
**先生**: 90m先まで照らせる。岩場のルートファインディングも楽になる。

**JK**: でも、そんなに明るいと電池の持ちが悪くなりませんか？

**先生**: いい指摘だ。実際、強モード（350lm）では約2時間しか持たない。だが弱モード（5lm）なら最大160時間だ。状況に応じて調整すればいい。

**JK**: 160時間って…6日以上？

**先生**: テント内では弱モードで十分だ。だから電池持ちは心配しなくていい。

**先生**: それから、このモデルには気の利いた設計がある。電源を入れると、最初は弱モードからスタートするんだ。

**JK**: え、それって意味あるんですか？いきなり明るくしたいときもあるじゃないですか。

**先生**: 山小屋で夜中にトイレに行くとき、いきなり最強モードで周囲を照らしたら顰蹙ものだろう。
...
**先生**: できる。ティカもティキナもハイブリッドコンセプト対応だ。COREバッテリーは単体で約3,500円で売っている。

**JK**: じゃあまずティカ買って、後からCOREバッテリー追加って選択肢もありますね！
...
- ナイトハイクや縦走登山をする
- トレイルランニングに興味がある
- 充電式メインで、いざというとき乾電池も使いたい
- 長く使える高性能モデルが欲しい

#### 注意点
- バッテリーボックスの開閉が固め（防水性とのトレードオフ）
- 旧モデルと新COREバッテリーの互換性に注意

---

## トレラン・ウルトラなら「SWIFT RL（スイフト RL）」

**JK**: 先生、もっと上のモデルってあるんですか？

**先生**: PERFORMANCEシリーズだ。「SWIFT RL」は2024年にアップデートされて、さらに進化した。

#### 主なスペック
- 最大ルーメン: 1100lm
- 照射距離: 155m
- 重量: 100g（バッテリー込み）
- 電源: 2350mAhリチウムイオンバッテリー（内蔵）
- 充電: USB Type-C
- 防水性能: IPX4
- 価格: 19,800円
...
**先生**: SWIFT RLには「リアクティブライティング」という機能がある。これが革命的なんだ。
...
**先生**: バッテリー消費も最適化されるから、長時間レースでも安心だ。
...
**先生**: そうだ。100gという軽さも相まって、長時間装着しても疲れにくい。
...
**先生**: ウルトラトレイルの100マイルレースなどで活躍する。

**JK**: あと「モバイルバッテリーとしても使える」って書いてありますけど…どういうことですか？
...
**先生**: 初心者には必要ない。だが、将来ウルトラトレイルを目指すなら覚えておくといい。

---

## 超軽量派なら「BINDI（ビンディ）」

**JK**: 先生、もっと軽いのってないんですか？ザックの重さを1gでも減らしたくて…。

**先生**: それなら「BINDI」だ。驚くほど軽い。

#### 主なスペック
- 最大ルーメン: 200lm
- 照射距離: 36m
- 重量: 35g
- 電源: 680mAhリチウムイオンバッテリー（内蔵）
- 充電: Micro USB
- 防水性能: IPX4
...
**先生**: 首にかけて使うこともできる。装着感がほとんどない。

**JK**: これ良さそう！でも200ルーメンで足りますか？

**先生**: 正直、本格的な登山には心細い。街中のランニングや、キャンプ場での移動、予備ライトとしては最高だ。
...
**JK**: ところで、COREバッテリーって本当に乾電池より優れてるんですか？

**先生**: データで見てみよう。

### COREバッテリー vs 単4アルカリ電池

| 項目 | COREバッテリー | 単4アルカリ電池 |
|------|----------------|-----------------|
| 低温性能 | 優れている | 低温で性能低下 |
| 明るさの安定性 | 長時間安定 | 放電で徐々に低下 |
| 1時間後の明るさ維持率 | 初期の50% | 約3分の1に低下 |
| 経済性 | 長期的に経済的 | 都度購入が必要 |
| 入手性 | 専用品 | どこでも購入可 |
...
**先生**: 普段はそうだ。だが、万が一に備えて乾電池も持っておく。それがハイブリッドコンセプトの真価だ。
...
**JK**: ルーメンルーメン言われても、正直ピンとこないんですけど…。

**先生**: 目安を教えよう。

| 用途 | 推奨ルーメン |
|------|-------------|
| テント内作業・読書 | 100lm前後で十分 |
| 一般的な登山・夜間歩行 | 200〜400lm |
...
**先生**: 日帰り登山やキャンプならその通りだ。ナイトハイクに興味があるなら、最初からACTIK COREを買っておくほうが後悔しない。
...
| モデル | 最大ルーメン | 重量 | 価格 | おすすめシーン |
|--------|-------------|------|------|---------------|
| TIKKINA | 300lm | 92g | 約4,000円 | 予備・キャンプ |
| TIKKA | 350lm | 94g | 約5,280円 | 日帰り登山・万能 |
| TIKKA CORE | 450lm | 84g | 約8,390円 | 充電派の万能 |
| ACTIK CORE | 625lm | 88g | 約12,000円 | 縦走・ナイトハイク |
| SWIFT RL | 1100lm | 100g | 19,800円 | トレイルラン |
| NAO RL | 1500lm | 145g | 高価格帯 | ウルトラトレイル |
| BINDI | 200lm | 35g | - | 超軽量・予備 |

**JK**: 私、まずTIKKAにします！赤色ライトあるし、蓄光で見失わないし。で、もっと本格的になったらCOREバッテリー買い足します！

**先生**: いい判断だな。

**JK**: あとTIKKINAも予備用に買っておこうかな…安いし。

**先生**: それも賢い。ヘッドライトは2つあると安心だ。1つ故障しても行動を続けられる。

**JK**: ありがとうございました！

**先生**: 最後に一言。ヘッドライトは実際に装着してフィット感を確かめるのが大事だ。頭の形は人それぞれ違うからな。登山用品店で試着してから決めるといい。
...
ほとんどのモデルがIPX4（全天候型）対応で、あらゆる方向からの水しぶきに耐えられます。小雨程度なら問題なく使用できますが、水中に沈めるような使い方はできません。

### Q. COREバッテリーは他ブランドのヘッドライトでも使えますか？

いいえ、ペツル専用です。ティキナ、ティカ、アクティックなど、ハイブリッドコンセプト対応モデルでのみ使用できます。

### Q. SWIFT RLで乾電池は使えますか？

使えません。SWIFT RLとNAO RLは充電式専用です。乾電池も使いたい場合はACTIK COREを選んでください。

### Q. 蓄光リフレクターって光るんですか？

はい。明るい場所で光を蓄えて、暗闘でぼんやりと光ります。テントの中でライトを探すときに見つけやすくなる便利な機能です。

### Q. 赤色ライトは登山で必要ですか？

山小屋で周囲に配慮したいとき、星空撮影のとき、夜間視力を維持したいときに便利です。必須ではありませんが、あると重宝します。
