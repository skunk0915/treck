# アークテリクス フリース・ミッドレイヤー完全ガイド【Delta・Kyanite・Covert徹底比較】

Tags: Fleece, Guide

![アークテリクスのフリースフーディを着た登山者が山岳地帯を歩く写真](/img/arcteryx_fleece_midlayer_complete_guide_01.jpg)

## 導入

アークテリクスのフリース、買いたいけど種類多すぎ！？

Delta、Kyanite、Covert…カタログ見てもどれが自分に合ってるのかさっぱり分からない…そんなふうに悩んでいませんか？

高価格帯だけに「失敗したくない」という気持ちもあるでしょう。でも安心してください。この記事では、アークテリクスの主要フリース3モデルを徹底比較し、あなたの活動スタイルに最適な一着を見つけるお手伝いをします。

---

## 登場人物紹介

**JK (女子高生)**: 登山を始めたばかりの初心者。見た目重視だけど機能性にも興味津々。アークテリクスのおしゃれな見た目に惹かれているが、価格の高さに躊躇中。

**先生 (登山ガイド)**: 登山歴20年のベテランガイド。道具への深い愛と知識を持ち、実体験に基づいたアドバイスができる。無骨だが誠実で、デメリットも隠さず伝えてくれる。

---

## なぜアークテリクスのフリースは種類が多いのか？

**JK**: 先生、アークテリクスのフリース見てたんですけど、Delta だの Kyanite だの Covert だの…名前が難しすぎて呪文みたいです。

**先生**: ははは。確かに最初は戸惑うだろうな。でもこれには理由がある。アークテリクスは「活動レベル」と「用途」に応じて最適化されたモデルを展開しているんだ。

**JK**: 活動レベル…ですか？

**先生**: そう。例えば激しく登る時と、ゆっくりハイキングする時では、求められる機能が全く違う。発汗量が多い高出力活動では「通気性」が最重要だが、低強度の活動や休憩時には「保温性」が大切だ。

**JK**: なるほど。それでモデルが分かれてるんですね。でも3種類もいります？

**先生**: 良い質問だ。実は各モデルには明確な役割がある。整理すると：

- **Delta**: 高出力活動向け（通気性特化型）
- **Kyanite**: 万能型（保温性と通気性のバランス）
- **Covert**: タウンユース・軽アウトドア向け（スタイル重視）
...
## 【通気性最強】Delta（デルタ）シリーズ

### Deltaの正体：息する軽量フリース

**先生**: まずは Delta から解説しよう。これは「動き続ける人」のためのフリースだ。

**JK**: 動き続ける…ってどういうことです？

**先生**: 登山では、急な登りでペースを上げたり、重い荷物を背負って長時間歩いたりするだろう。そういう時、体は大量の熱と汗を発生させる。普通のフリースだと、この熱がこもって蒸れてしまうんだ。

**JK**: あー、運動した後にベタベタするやつですね。嫌い。
...
**先生**: 繊維の断面が「8本の突起を持つ中空構造」になっているからオクタ(8)なんだ。このタコ足みたいな構造が空気を大量に取り込みつつ、湿気も素早く逃がす。

**JK**: タコ足…想像したらちょっと可愛いかも（笑）

**先生**: さらに重要な点がある。従来のフリースは起毛させて毛足を作るが、Deltaは起毛させずに毛足を作る製法を採用している。
...
**先生**: 鋭い質問だな。実はそこが Delta の特性を理解する上で最も重要なポイントなんだ。

### Delta の真実：動いている時だけ暖かい

**先生**: Delta は「動いている時に最適な保温性」を発揮する設計だ。逆に言えば、立ち止まると結構寒い。

**JK**: えっ、それってデメリットじゃないですか！？
...
**先生**: そうとも言える。でも逆に、レイヤリングを理解している人にとっては、これ以上ない快適さを提供してくれる。汗冷えしないから、むしろ体温管理が楽になるんだ。

#### 主なスペック

- **素材**: Octa® Polyester Fleece（100%ポリエステル）
- **重量**: 約275g（Delta LT Hoody メンズMサイズ）
...
- 静止時の保温性は低め（休憩時は別のレイヤーが必要）
- 防風性はほぼゼロ（風が吹くと体感温度が下がる）
- 単体でのタウンユースには不向き

**JK**: うーん、私にはまだ早いかなぁ。もっと初心者でも使いやすいのってないですか？

**先生**: それなら次の Kyanite が最適だろう。

---

## 【万能型】Kyanite（カイヤナイト）シリーズ

### 初心者からベテランまで：Kyaniteの汎用性

**先生**: Kyanite は「迷ったらコレ」と言えるほど、バランスの取れたフリースだ。
...
**JK**: ポーラテック…聞いたことあります。パタゴニアとかでも使われてたような。

**先生**: よく知ってるな。そう、業界標準とも言える高品質フリース素材だ。Kyanite の表面はナイロンで補強されているから、耐久性が高く毛玉もできにくい。内側はポリエステルの起毛で、肌触りが本当に気持ちいい。

**JK**: 触り心地大事！でも Delta より重そうですね？
...
#### Kyaniteの隠れた強み：ピリングしにくい

**先生**: もう一つ重要な点がある。Kyanite は表面がナイロンでできているから、毛玉（ピリング）ができにくいんだ。

**JK**: あー、安物のフリースってすぐ毛玉だらけになりますもんね…
...
**先生**: ああ。Kyanite は「投資する価値がある一着」と言える。登山だけでなく、キャンプや普段着としても活躍する。

**JK**: 普段着…！それ大事です。山でしか使えないのはもったいないし。

#### 主なスペック

- **素材**: Polartec® Power Stretch® Pro（ナイロン面 + ポリエステル起毛内側）
- **重量**: 約300g（メンズMサイズ）※モデルにより425gのものもあり
...
- 登山初心者〜中級者で、最初の一着を探している人
- 3シーズン（春夏秋）の低〜中難度登山が中心の人
- 冬の低山でミッドレイヤーとして使いたい人
- 普段着やキャンプでも使いたい人
- 耐久性を重視する人

#### 注意点

- Delta ほど通気性は高くない（激しい登りでは汗をかきやすい人は注意）
- 完全防風ではない（強風時はシェルが必要）
- 価格が $150-200 と高め

**JK**: うーん、私には Kyanite が合ってそう。でも、もう一つの Covert も気になります。おしゃれっぽい名前だし。

**先生**: ふふ、そう来ると思った。Covert は少し毛色が違うモデルだ。

---

## 【タウンユース特化】Covert Cardigan（コバート カーディガン）

### セーター風フリース：Covert の独自性

**先生**: Covert Cardigan は、他の2つと明確に違う路線を行っている。一言で言えば「山も街も着こなせるスタイリッシュなフリース」だ。

**JK**: やっぱり！見た目がウールのカーディガンみたいですもんね。
...
**JK**: それめっちゃいい！ウールって暖かいけどチクチクするから嫌いなんですよ。

**先生**: まさにそのニーズに応えたモデルだな。オフィスでも違和感なく着られるし、週末の軽いハイキングにも対応できる。

**JK**: でも登山には向かないんですか？

**先生**: 本格的な登山には不向きだ。理由は2つある。

### Covert の弱点：防風性と重量

**先生**: 一つ目は、Covert のフリースはボリューミーだが密度が低い。つまり風を通しやすいんだ。
...
**先生**: 重量だ。メンズで約535g、レディースでも420g。Delta の約2倍近い。

**JK**: うわっ、結構重い…

**先生**: ただし、このボリューム感が「セーターのような見た目」を作っているわけだ。トレードオフだな。

#### Covert が輝く場面

**先生**: とはいえ、Covert には明確な強みがある。「登山ギアっぽくない」ことだ。

**JK**: それって…良いことですよね？

**先生**: もちろん。例えば下山後にそのまま温泉街を散策したり、カフェに寄ったりする時、Covert は自然に馴染む。Delta や Kyanite は明らかに山ウェアだからな。

**JK**: あー確かに！下山後も楽しみたいですもんね。
...
- **素材**: Alpenex II™ フリース（100%リサイクルポリエステル）
- **重量**: 約535g（メンズ）、約420g（レディース）
...
- 登山だけでなく、普段着やオフィスでも使いたい人
- 見た目のスタイリッシュさを重視する人
- 軽い日帰りハイキングやキャンプが中心の人
- 下山後の行動も視野に入れたい人
...
**JK**: なるほど… Covert も魅力的だけど、私にはやっぱり Kyanite が一番合ってそうかな。

**先生**: 良い判断だ。ただ、最終的に決める前に、3モデルを並べて比較してみよう。
...
| モデル | Delta | Kyanite | Covert |
|---|---|---|---|
| **主要素材** | Octa® Polyester | Polartec® Power Stretch® Pro | Alpenex II™ |
| **重量** | 約275g | 約300g | 約535g |
| **価格** | $159-170 | $150-200 | $180 |
| **保温性** | 低〜中（動いている時のみ） | 中〜高 | 中〜高 |
| **通気性** | 最高 | 高 | 中 |
| **耐久性** | 高 | 最高 | 中 |
| **防風性** | 無 | 低 | 無 |
| **フィット** | トリム | レギュラー | レギュラー |
| **おすすめ用途** | 高出力登山・縦走 | 万能（登山〜普段着） | タウンユース・軽登山 |

**JK**: こうして見ると、本当に性格が違いますね。
...
**先生**: 正解。重い荷物を背負って長時間登る場合、通気性が最優先だ。Delta なら行動中も快適で、停滞時は別のレイヤーで調整できる。

#### 【シーン2】秋の低山日帰りハイキング（紅葉狩り）

**JK**: うーん… Kyanite？それとも Covert？

**先生**: どちらでも良いが、運動強度が中程度なら Kyanite がベター。ただし下山後にカフェ巡りを楽しみたいなら Covert もアリだ。

#### 【シーン3】冬の低山（雪なし）

**JK**: Kyanite をミッドレイヤーにして、その上にハードシェル…？

**先生**: 完璧だ。Kyanite はミッドレイヤーとしても優秀だからな。

#### 【シーン4】春のキャンプ（焚き火あり）

**JK**: これは Covert ですか？焚き火の火の粉とか気になるけど…

**先生**: 火の粉には全モデル弱いから要注意だ。ただ、焚き火から距離を取るなら Covert のスタイリッシュさが映える。

**JK**: なるほど。結局、私の最初の一着は Kyanite で決まりかな。

**先生**: 良い選択だ。では、実際に購入する前に知っておくべきことを話そう。
...
**JK**: ネットで買おうと思ってるんですけど、サイズ選び失敗したくないんです。

**先生**: 分かる。アークテリクスは北米ブランドだから、日本人には少し大きめに感じることがある。基本的な計測方法を教えよう。

#### 計測すべき4箇所

**先生**: 以下を測定する。

1. **袖丈**: 首の後ろから肩を通って手首まで（腕は軽く曲げた状態で）
2. **胸囲**: 胸の一番膨らんだ部分を水平に一周
...
**先生**: アークテリクス公式サイトのサイズチャートと照らし合わせる。もし2サイズの境界線上なら：
...
**JK**: せっかく高いの買うんだから、長く使いたいです。洗濯って普通にしていいんですか？

**先生**: 基本的には家庭で洗濯可能だが、いくつかルールがある。

#### 洗濯の基本手順

1. **準備**: 全てのジッパーを閉め、ポケットのジッパーは開けて中身を出す。洗濯ネットに入れるとダメージを軽減できる。
2. **洗剤選び**: 中性洗剤または GORE-TEX 専用洗剤を使う。柔軟剤・漂白剤・香料入りは NG。
3. **水温**: 30〜40°C の低温設定。
4. **コース**: 弱水流コースまたは手洗いコース。
...
**先生**: 柔軟剤は撥水加工を阻害するから絶対に使わないこと。あとアイロンも NG だ。

**JK**: 分かりました。どれくらいの頻度で洗えばいいですか？

**先生**: 5回着用したら洗濯、もしくは汚れが目立ってきたら洗う。汚れを放置する方がダメージになる。
...
**JK**: Kyanite、どこで買うのが一番お得ですか？

**先生**: 価格帯は約28,000〜32,000円が相場だ。購入先は主に3つ。

#### 購入先オプション

1. **公式オンラインストア**: 最新モデルが確実に手に入る。セール時期は要チェック。
...
**先生**: 正規品より安いこともあるが、保証が受けられない場合がある。それとサイズ表記が異なることも。リスクを理解した上で判断してくれ。

**JK**: なるほど。初めてなら正規店で買った方が安心ですね。
...
**先生**: さて、ここまで3モデルを見てきたが、君はもう決めたかな？

**JK**: はい！私は Kyanite でいきます。理由は3つあって：

1. 初心者でも使いやすい万能性
2. 普段着にも使えるデザイン
3. 耐久性が高くて長く使える

**先生**: 完璧な理由だな。では最後に、各モデルに向いている人を整理しておこう。
...
**先生**: 最後に一つだけ。どのモデルを選ぶにしても、必ずお店で試着してからにすること。フィット感は写真では分からないからな。

**JK**: 分かりました！週末、銀座の直営店に行ってきます！
...
**JK**: あ、ちょっと待ってください。いくつか質問があります。

**先生**: 何だ？

### Q1: Delta と Kyanite、両方買うのはアリですか？

**先生**: 経済的に余裕があれば、むしろ推奨する。Delta は夏の縦走、Kyanite は 3シーズンの汎用…という使い分けができる。

### Q2: 女性用モデルは男性用と何が違うんですか？

**先生**: 主に3点だ。①肩幅と袖の長さが女性の体型に合わせてある。②ウエストとヒップのシルエットが違う。③カラーバリエーションが若干異なる。性能は同じだ。

### Q3: 旧モデルと新モデルの違いは？

**先生**: Delta は 2024年から Octa® 素材に変わった。これが最大の変更点だ。旧モデルは Polartec® Power Dry だったが、性能的には新モデルの方が上だ。
...
**先生**: 正直に言うと、パタゴニアの R1 や Houdini の Power Houdi も優秀だ。ただアークテリクスは「耐久性」と「デザインの洗練度」で一歩リードしていると感じる。

---

## 締めくくり

**先生**: 最後に一つ。道具選びで最も大切なのは「自分の使い方を理解すること」だ。

**JK**: というと？

**先生**: Delta、Kyanite、Covert…どれも素晴らしいフリースだが、万能な道具は存在しない。自分がどんな山行をするのか、どんなシーンで使いたいのか。それを明確にすれば、自ずと答えは見えてくる。

**JK**: なるほど。だから私には Kyanite がぴったりなんですね。

**先生**: そういうことだ。良い道具と一緒に、素晴らしい山行を楽しんでくれ。
