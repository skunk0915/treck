# スノーピークのIGT（アイアングリルテーブル）、種類多すぎ!?登山ガイドの先生が教える「失敗しない選び方」
Tags: Snow Peak, Camping Gear, Guide

![スノーピーク IGTシステムを使ったキャンプキッチンのセットアップ。フラットバーナーや竹製天板が組み込まれた美しいテーブル。](/img/snowpeak_igt_system_complete_guide_01.jpg)

## 導入

「スノーピークのIGTって何？」「フレームとか脚とか種類が多すぎて、何を買えばいいかわからない…」そんな声をよく聞きます。キャンプ場で見かけるオシャレなキッチンテーブル、実はIGTシステムで構築されていることが多いんです。

この記事では、登山ガイド歴20年の先生と一緒に、IGTシステムの基本から選び方、おすすめの組み合わせまで詳しく解説していきます。IGT沼にハマる前に、まずは正しい知識を身につけましょう。

---

## 登場人物紹介

**JK (女子高生)**: 登山・キャンプ初心者。見た目重視で、可愛いキャンプギアに目がない。専門用語は苦手だけど、素朴な疑問をどんどんぶつける。

**先生 (登山ガイド)**: 登山歴20年のベテランガイド。キャンプギアにも造詣が深く、機能性を重視しつつも初心者目線での解説が得意。

---

## IGT（アイアングリルテーブル）システムとは？

**JK**: 先生、キャンプ場でよく見るアレ、なんていうんですか？バーナーが埋め込まれてて、すごくオシャレなテーブルみたいなやつ。
...
**先生**: 簡単に言うと、フレーム、脚、バーナーや天板といったパーツを自由に組み合わせて、自分好みのテーブルを作れるシステムだ。ソロキャンプから大人数のバーベキューまで、様々なシーンに対応できる。

**JK**: へ〜！じゃあ同じIGTでも、人によって全然違う見た目になるってことですか？

**先生**: その通り。だからこそ「IGT沼」なんて言葉もあるんだ。次々とパーツを買い足したくなる…という危険な魅力がある。

**JK**: 沼…！？ 私、すでにハマりそうな予感がします…。
...
**先生**: だいたいA4用紙より少し小さいくらいだ。このサイズを基準にして、バーナーや天板がピッタリはまるように設計されている。だから純正品はもちろん、他社の互換製品も組み込めるんだ。

**JK**: なるほど！規格があるから、いろんなメーカーのパーツが使えるんですね。

---

## IGTフレームの種類を比較

> **Image Prompt:** 様々なIGTフレームが並んだ様子。3ユニットフレーム、4ユニットフレーム、エントリーIGT、IGTスリムなどが分かりやすく展示されている。

**JK**: で、フレームっていくつも種類があるんですよね？どれを選べばいいか迷っちゃいます…。

**先生**: 主なフレームの種類を説明しよう。用途に合わせて選ぶのがポイントだ。

### IGTフレーム（標準タイプ）

**先生**: まずは基本となるIGTフレーム。3ユニットと4ユニットサイズがある。

| 製品名 | サイズ | ユニット数 | 重量 |
|:------|:------|:---------|:-----|
| IGTフレーム 3ユニット | 約820mm×490mm×30mm | 3ユニット | 4.2kg |
| IGTフレーム 4ユニット | 約1096mm×496mm×30mm | 4ユニット | 4.9kg |
...
**JK**: 初心者にはハードル高そう…。もっと簡単なのないですか？

**先生**: そんな君にはエントリーIGTをおすすめする。
...
**先生**: ただし注意点がある。高さが400mm固定なんだ。ロースタイル専用ということになる。

**JK**: あ〜、じゃあハイチェアとは合わせられないんですね。

### IGTスリム

**先生**: 見た目を重視するならIGTスリムも選択肢に入る。
...
**先生**: ふふ、見た目は確かに素晴らしい。ただ、それなりの価格帯になるから覚悟が必要だ。
...
**先生**: そうだな。収納性を重視するなら検討の価値がある。

---

## 脚の高さでスタイルが変わる

> **Image Prompt:** 4種類の高さの異なるIGT脚セットが並んでいる様子。それぞれの高さでの使用シーン（グラウンドスタイル、ロースタイル、ミドルスタイル、ハイスタイル）が分かるイラスト。

**JK**: 脚の種類も何個かあるんですよね？

**先生**: 脚セットは2本1組で販売されていて、4種類の高さがある。これでテーブルの高さが決まるんだ。

| 脚の高さ | スタイル名 | 用途・特徴 |
|:--------|:---------|:---------|
| 300mm | グラウンドスタイル | 地面に座って使用。ピクニックや幼児向けに最適 |
| 400mm | ロースタイル | ローチェアやベンチに座って調理や食事。焚き火を囲む際にも◎ |
...
**先生**: その通り。最近のキャンプでは400mmのロースタイルが主流だな。焚き火を囲んでゆったり過ごすには最適な高さだ。

**JK**: じゃあ830mmは何に使うんですか？立ちっぱなし？

**先生**: 830mmはハイスタイルと言って、立って調理するのに向いている。料理好きなキャンパーに人気だな。腰を曲げずに作業できるから、長時間の調理でも疲れにくい。

**JK**: なるほど〜。でも両方買わないといけないってこと？

**先生**: 必要な高さだけ買えばいい。最初は400mmか660mmどちらかから始めるのがおすすめだ。

---

## フラットバーナー徹底解説

> **Image Prompt:** スノーピークのフラットバーナーがIGTフレームにセットされた状態。天板とフラットになっている様子が分かるアングル。

**JK**: IGTといえばバーナーですよね！よく見かける、テーブルに埋め込まれてるやつ。

**先生**: フラットバーナー（GS-450R）のことだな。IGTシステムの中核とも言えるアイテムだ。
...
**先生**: そうだな。強火での炒め物やピザ焼きには火力不足を感じることがある。ただ、カレーやシチューなどの煮込み料理、お湯を沸かす、焼肉といった一般的なキャンプ料理には十分だ。

### フラットバーナーのメリット

**先生**: フラットバーナーの最大の特徴は、その耐風性だ。バーナーヘッドが本体に窪んで配置されているから、風の影響を受けにくい。

**JK**: 確かに！外で火を使うと風で消えたりしますもんね。

**先生**: それと、分解して細かくパーツを分けられるから、使用後の清掃が楽なのも良い点だ。
...
- **単体での使用**: 脚を取り付けて卓上で使用可能
- **IGTへの組み込み**: 脚を外してフレームにセット。ガスカートリッジはレール部分に吊り下げ

**JK**: え、単体でも使えるんですか！？

**先生**: そうだ。脚を付ければカセットコンロのように使える。IGTを持っていない友人宅でも活躍するぞ。

---

## 廃盤だけど人気！ギガパワープレートバーナーLI
...
**先生**: ガスカートリッジを逆さまにして液体のままガスを供給する方式だ。これにより寒冷地（氷点下5〜6度程度）でも安定した火力を出せる。

### フラットバーナー vs ギガパワープレートバーナーLI

| 項目 | フラットバーナー | ギガパワープレートバーナーLI |
|:----|:--------------|:------------------------|
| IGTとの一体感 | 天板とフラット◎ | 組み込み可能、ハンドル付き |
| 耐風性 | 優れている | やや劣る |
| 寒冷地性能 | 火力低下しやすい | 安定した高火力 |
| 重量 | 約1.9kg | 約2.7kg |
| 入手性 | 現行品 | 廃盤（中古市場） |

**JK**: じゃあ冬キャンプするならギガパワーの方がいいんですか？

**先生**: 冬キャンプや標高の高い場所での使用が多いなら、ギガパワープレートバーナーLIの方が安心だな。ただ、廃盤だから中古で探すしかない。

**JK**: う〜ん、悩ましい…。でも私は普通のキャンプがメインだからフラットバーナーでいいかな！

---

## 天板・トレーのバリエーション

> **Image Prompt:** IGTに様々な天板やトレーがセットされている様子。ウッドテーブル（竹）、ステンレストレー、メッシュトレーが並んでいる。

**JK**: バーナー以外にはどんなパーツがあるんですか？

**先生**: 天板やトレーのバリエーションも豊富だ。
...
**JK**: 木の感じ、可愛いですよね〜。でも熱いもの置いたら焦げませんか？

**先生**: いい質問だ。木製天板には熱いものを直接置かない方がいい。そこで登場するのがステンレストレーだ。
...
**先生**: そうだな。メッシュトレーは通気性が良いから、洗った食器や調理器具をそのまま収納して乾燥させられる。実用的なパーツだ。

---

## マルチファンクションテーブルで拡張しよう

**JK**: もっと広いスペースが欲しい場合はどうするんですか？
...
**先生**: ははは。さすがにそこまでは必要ないだろうが、ファミリーキャンプやグループキャンプでは重宝するぞ。

### マルチファンクションテーブルの種類

- **ノーマル**: 標準サイズ
- **ロング**: 長いサイズ
- **コーナータイプ（R/L）**: L字型やコの字型のレイアウトが可能

**JK**: L字型キッチンとか作れるんですか！？本格的〜！

**先生**: 対面式のキッチンにすれば、複数人で料理を楽しめる。大人数でのバーベキューにも対応できるぞ。

---

## コスパ重視！サードパーティ製IGT互換品

> **Image Prompt:** 様々なサードパーティ製IGT互換テーブルが並んでいる様子。ラーテルワークス、WAQ、Naturehikeなどのブランドロゴ入り。

**JK**: 正直なところ、スノーピークって高いですよね…。もっと安いのないんですか？
...
| ブランド | 主な製品 | 特徴 |
|:--------|:------|:----|
| ラーテルワークス | ウッドパネルテーブル | コスパと機能性、デザイン性◎ |
| WAQ | マルチローテーブル | 軽量で使いやすい |
| Naturehike | IGTアウトドアテーブル | 天然木とアルミ合金のおしゃれデザイン |
| ゼインアーツ | トードテーブル | 人気ブランドの品質 |
| アルペンアウトドアーズ | アルミユニットテーブル88 | 軽量コンパクト |
| 37CAMP | フレームテーブル | 様々なユニット展開 |

**JK**: こんなにあるんですか！？サードパーティ製でもスノーピークのフラットバーナーは使えるんですか？

**先生**: IGT規格に準拠していれば使える。ただし、製品によっては若干のサイズ差で隙間ができたり、完全にはフィットしないこともある。

**JK**: なるほど…。買う前にレビューとか確認した方がいいですね。
...
**先生**: SOTO ST-310やST-340をIGTフレームにビルトインできるプレートがサードパーティから出ている。すでにSOTOのバーナーを持っているなら、活用できるぞ。

**JK**: それいいですね！手持ちのギアを活かせるのは嬉しい！

---

## 初心者におすすめの組み合わせ

**JK**: 結局、初心者は何を買えばいいんですか？選択肢が多すぎて頭がパンクしそうです…。

**先生**: 初心者向けに3つのパターンを紹介しよう。
...
- 高さが400mm固定なので、ハイチェアとは合わせにくい

### パターン2: 拡張性重視「IGTフレーム + 400mm脚 + フラットバーナー」

**先生**: 将来的にカスタマイズしたいなら、フレームと脚を別々に買うパターンがおすすめだ。
...
### パターン3: コスパ重視「サードパーティ製テーブル」

**先生**: 予算を抑えたいなら、サードパーティ製のIGT互換テーブルから始めるのも一つの手だ。

#### こんな人におすすめ

- 予算を抑えたい人
- 手持ちのバーナー（SOTOなど）を活用したい人
- まずはIGTシステムを試してみたい人

#### 注意点

- 純正パーツとの互換性に若干の差がある場合も

**JK**: 私はパターン1かな〜。まずは試してみて、ハマったらパーツを増やしていく感じで！

**先生**: 賢明な判断だ。IGT沼にハマるかどうか、まずは様子を見るのがいい。

---

## IGTのメリットとデメリット

**JK**: 改めて、IGTのいいところと悪いところを教えてください！

### メリット

**先生**: メリットは大きく5つある。

1. **高いカスタマイズ性**: フレーム、脚、ユニット、アクセサリーを自由に組み合わせて、無限に近いアレンジが可能
2. **多様な用途への対応**: キッチン、ダイニング、収納など、キャンプスタイルや人数に合わせて柔軟にレイアウト変更可能
3. **耐久性とデザイン性**: アルミ素材や竹集成材など高品質な素材を使用。シンプルで洗練されたデザイン
4. **収納性**: フレームはコンパクトに折りたたみ可能
5. **拡張性**: マルチファンクションテーブルなどと連結して拡張可能

**JK**: うんうん、いいところは分かりました！でも悪いところも知りたいです。
...
3. **組み立ての手間**: モデルによっては、組み立てがやや面倒
4. **収納・運搬のかさばり**: 大型のフレームや拡張パーツは、車の積載スペースを圧迫
5. **高さ調整の制限**: エントリーIGTなど一部モデルでは高さ固定

**JK**: IGT沼、怖い…。お財布と相談しながらですね。

**先生**: その通り。計画性を持って買い足していくことが大切だ。
...
- **初期投資と追加費用**: 後からユニットを追加すると総額が膨らむ
- **互換性の確認**: サードパーティ製品は購入前にレビューで互換性をチェック
- **積載量の確認**: 車の荷室サイズを考慮してフレームを選ぶ
- **木製天板の取り扱い**: 暖房器具の熱や直射日光、夏場の車内で反りや歪みが発生する可能性あり
- **耐荷重**: 本製品の耐荷重は30kg以下

**JK**: 30kg以下ってことは、ダッチオーブンとか置いても大丈夫ですか？

**先生**: ダッチオーブン程度なら問題ない。ただ、均等に荷重がかかるように注意することが大切だな。

---

## まとめ：IGT選びの比較表

| 製品 | ユニット数 | 脚 | 価格帯 | おすすめポイント |
|:----|:---------|:--|:------|:-------------|
| IGTフレーム 3ユニット | 3 | 別売り | 高め | カスタマイズ重視派に |
| IGTフレーム 4ユニット | 4 | 別売り | 高め | 大人数・大スペース派に |
| エントリーIGT | 3 | 付属（固定） | 手頃 | 初心者に最適 |
| IGTスリム | 3 | 付属 | 高め | デザイン重視派に |
| セパレートIGT | 2〜3 | 別売り | 中程度 | 収納性重視派に |
| サードパーティ製 | 様々 | 製品による | 手頃 | コスパ重視派に |

**JK**: 私、決めました！まずはエントリーIGTとフラットバーナーのセットを買います！

**先生**: いい選択だ。IGTシステムは長く使えるものだから、焦らず少しずつ自分好みのシステムを作っていくといい。

**JK**: 先生、ありがとうございました！次のキャンプが楽しみです〜！

**先生**: 楽しいキャンプライフを。くれぐれもIGT沼にはまりすぎないように気をつけるんだぞ。
...
### Q1: IGTフレームと脚は別々に買わないといけないんですか？

**先生**: 標準のIGTフレームは脚が別売りだ。ただし、エントリーIGTやIGTスリムなどは脚が付属しているモデルもある。最初に確認してから購入しよう。

### Q2: 冬キャンプでフラットバーナーは使えますか？

**先生**: 使えるが、気温が低いと火力が落ちやすい。寒冷地での使用が多い場合は、液出し機構付きのギガパワープレートバーナーLI（廃盤・中古）を検討するか、ガスカートリッジを寒冷地用にするといい。

### Q3: サードパーティ製品との互換性は大丈夫ですか？

**先生**: IGT規格に準拠していれば基本的に問題ない。ただし、製品によっては微妙なサイズ差で隙間ができることもあるから、購入前にレビューを確認することをおすすめする。

### Q4: IGTのメンテナンス方法は？

**先生**: 使用後は汚れを拭き取り、しっかり乾燥させることが大切だ。特に木製天板は直射日光や高温を避け、たまにウッドオイルで手入れすると長持ちする。バーナー部分は分解して清掃できるから、こまめに掃除しよう。

### Q5: 車に積めるか心配です。どのくらいのサイズですか？

**先生**: IGTフレーム4ユニットで約110cm×50cm程度だ。車の荷室サイズを事前に確認しておくといい。収納性を重視するなら、セパレートIGTが分解できておすすめだ。
